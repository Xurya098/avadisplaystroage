function launch_chaty(t) {
        ...
        n.length && (t("body").append('<svg width="39" height="39" viewBox="0 0 39 39" class="hide-cht-svg-bg" fill="none" xmlns="http://www.w3.org/2000/svg"><defs> <linearGradient id="linear-gradient" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4a64d5"/> <stop offset="0.322" stop-color="#9737bd"/> <stop offset="0.636" stop-color="#f15540"/> <stop offset="1" stop-color="#fecc69"/> </linearGradient> <linearGradient id="linear-gradient-insta-dm" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4A64D5"></stop> <stop offset="0.322" stop-color="#9737BD"></stop> <stop offset="0.636" stop-color="#F15540"></stop> <stop offset="1" stop-color="#FECC69"></stop> </linearGradient></defs>'), t.each(n, (function(e, a) {
                ...
                y && (s ? function() {
                    if (window.history && window.history.pushState && y) {
                        function e() {
                            y && "" !== location.hash.split("#!/")[1] && "" === window.location.hash && W()
                        }
                        var a = 100;
                    ...
                    function e(t, e, a) {
                        t.addEventListener ? (t.addEventListener(e, a, !1), W()) : t.attachEvent && t.attachEvent("on" + e, a)
                    }
                    e(document, "mouseout", (function(t) {
                        null == t.toElement && null == t.relatedTarget && W()
                    }))
    ...
    function j(a) {
            ...
            if (!L(c)) {
                ...
                if (i && (t("#" + c).addClass("is-active"), t("#" + c).length)) {
                    ...
                    if ("on" == chaty_settings.data_analytics_settings) {
                        ...
                        if (G(a, "v-" + r) && void 0 !== r && (O(a, "v-" + r), l.push(r)), !h && l.length) {
        ...
        if (g) {
            ...
            if (t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single")) p = 1, r = t("#chaty-widget-" + a + " .chaty-channel").data("channel"), G(a, "v-" + r) && void 0 !== r && (O(a, "v-" + r), l.push(r));
                ...
                r = t(this).data("channel"), G(a, "v-" + r) && void 0 !== r && (O(a, "v-" + r), l.push(r))
            })));
            if (g && !h) {
            ...
            if (t.each(e.agent_data, (function(t, e) {
                ...
                return null == h && (h = -1),
                    function(e, a) {
                                ...
                                var h = function(e, a, c, n, i, o) {
                                    ...
                                    if ("Whatsapp" == a.channel_type) {
                                        ...
                                        if (!L(e.pre_set_message)) {
                                            ...
                                            var y = t("title").text();
                                            d = (d = L(y) ? d.replace(/{title}/g, "") : d.replace(/{title}/g, y)).replace(/{url}/g, window.location), d = encodeURIComponent(d)
                                        }
                                        s ? (l = "", h = "https://wa.me/" + r + "?text=" + d) : (l = "_blank", h = P(e.use_whatsapp_web) ? "https://web.whatsapp.com/send?phone=" + r + "&text=" + d : "https://wa.me/" + r + "?text=" + d)
                        ...
                        })), c += "</div>", c += "</div>", c += "</div>", c += "</div>", ("Instagram" != e.channel && "Instagram_DM" != e.channel || "#ffffff" != e.header_bg_color) && (u += ".chaty-agent-header.agent-info-" + a + "-" + e.channel + " { background: " + e.header_bg_color + "; color: " + e.header_text_color + " } ");
                        u += ".agent-info-" + a + "-" + e.channel + " .chaty-close-agent-list svg { fill: " + e.header_text_color + " } ", t("body").append(c)
                    }(e, a), o = T(e, D(e), c, a), ("Instagram" != e.channel_type && "Instagram_DM" != e.channel_type || "#ffffff" != e.icon_color && "#fff" != e.icon_color) && (u += ".chaty-agent-" + a + "-" + e.channel + " .color-element {fill: " + e.icon_color + "; color: " + e.icon_color + ";}"), u += ".chaty-agent-" + a + "-" + e.channel + " .chaty-custom-icon { background-color: " + e.icon_color + ";}", u += ".chaty-agent-" + a + "-" + e.channel + " .chaty-svg-img { background-color: " + e.icon_color + ";}", "<div data-form='chaty-form-" + a + "-" + e.channel_type + "' class='chaty-channel chaty-agent-button chaty-agent-" + a + "-" + e.channel + " " + e.channel + "-channel" + n + "' id='" + e.channel + "-" + a + "-channel' data-id='" + e.channel_type + "-" + a + "' data-widget='" + a + "' data-channel='" + e.channel + "'>" + o + "</div>"
            }
        }
    }
            ...
            if (P(e.has_welcome_message)) e.url = "javascript:;", e.target = "", i += " has-chaty-box chaty-whatsapp-btn-form",
                function(e, a) {
                    ...
                    var l = "https://web.whatsapp.com/send",
                        r = "";
                    s ? l = "https://wa.me/" + e.value : (l = P(e.is_use_web_version) ? "https://web.whatsapp.com/send" : "https://wa.me/" + e.value, r = "_blank");
    ...
    function A(e) {
        j(e), t(".chaty-widget-" + e).removeClass("on-chaty-delay"), t(".chaty-widget-" + e).removeClass("on-chaty-exit-intent"), t(".chaty-widget-" + e).removeClass("on-chaty-scroll"), t(".chaty.on-chaty-delay").length || (clearInterval(a), l = !1), t(".chaty.on-chaty-exit-intent").length || (y = !1), t(".chaty.on-chaty-scroll").length || (d = !1)
    }

...
function epObserveTarget(t, e) {
    ...
    s.rootMargin = s.rootMargin || "10% 0px 0px 0px", new IntersectionObserver((function(t, a) {
        t.forEach((function(t) {
            t.isIntersecting && (e(t), s.loop || a.unobserve(t.target))
        }))
    }), s).observe(t)
}
...
function EP_SAFE_HTML(t) {
    ...
    return t = t.replace(/<\/?([a-zA-Z0-9]+)([^>]*)>/g, ((t, s, a) => {
        if (s = s.toLowerCase(), !e.hasOwnProperty(s)) return "";
        const l = e[s];
        return `<${s}${a.replace(/([a-zA-Z0-9-]+)\s*=\s*("[^"]*"|'[^']*'|[^\s>]*)/g,((t,e,s)=>(e=e.toLowerCase(),!l.includes(e)||e.startsWith("on")||/^javascript:/i.test(s)?"":`${e}=${s}`)))}>`
    }))
}
...
function returnCurrencySymbol(t = null) {
    ...
    t(document).ajaxComplete((function(e, s, a) {
        if (s.responseJSON && void 0 !== s.responseJSON.cart_hash && s.responseJSON.cart_hash) {
            var l = !1;
            if (a.url && a.url.indexOf("wc-ajax=add_to_cart") > -1 && (l = !0), a.data && a.data.indexOf("action=add_to_cart") > -1 && (l = !0), l && t(".bdt-offcanvas").hasClass("__update_cart")) {
                let e = t(".bdt-offcanvas.__update_cart").attr("id");
                bdtUIkit.util.ready((function() {
                    bdtUIkit.offcanvas("#" + e).show()
                }))
            }
        }
        ...
        jQuery(".bdt-ss-link").on("click", (function() {
            var t = jQuery("<input>");
            jQuery("body").append(t), t.val(jQuery(this).data("url")).select(), document.execCommand("copy"), t.remove(), jQuery(this).find(".bdt-social-share-title").html(jQuery(this).data("copied")), setTimeout((() => {
        ...
        const t = {
            ...
            "elementor-widget-bdt-post-block-modern": {
                selectors: [".bdt-post-block-modern-title a", ".bdt-post-block-modern-read-more"]
            },
        ...
        var e = {
            ...
            initGlassEffect: function() {
                jQuery(".bdt-glass-effect-yes").each((function() {
                    var t = jQuery(this);
                    if (!t.data("glass-effect-overlay-added")) {
                        var e = jQuery('<div class="bdt-glass-effect-overlay"></div>');
                        t.prepend(e), e.css({
                            position: "absolute",
                            "z-index": "0",
                            inset: "0",
                        ...
                        }), t.data("glass-effect-overlay-added", !0)
                    }
                }))
            }
        };
        e.init(), "undefined" != typeof elementorFrontend && elementorFrontend.hooks.addAction("frontend/element_ready/global", (function() {
            e.init()
        }))
    }))
}(jQuery);
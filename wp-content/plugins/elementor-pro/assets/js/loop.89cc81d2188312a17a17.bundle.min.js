    ...
    [993], {
        2098: (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.SAVE_CONTEXT = t.EDIT_CONTEXT = void 0, t.createElement = createElement, t.default = function addDocumentHandle({
                element: e,
                id: t,
                title: n = o("Template", "elementor-pro")
            }, a = r, d = null, m = null) {
                if (r === a) {
                    if (!t || !e) throw Error("`id` and `element` are required.");
                    if (function isCurrentlyEditing(e) {
                            return e.classList.contains(i)
                        }(e) || function hasHandle(e) {
                            return !!e.querySelector(`:scope > .${s}`)
                        }(e)) return
                }
                const c = function createHandleElement({
                    title: e,
                    onClick: t
                }, n, i = null) {
                    const a = ["header", "footer"].includes(i ? .dataset.elementorType) ? "%s" : o("Edit %s", "elementor-pro"),
                        d = createElement({
                            tag: "div",
                            classNames: [`${s}__inner`],
                            children: [createElement({
                                tag: "i",
                                classNames: [getHandleIcon(n)]
                            }), createElement({
                                tag: "div",
                                classNames: [`${r===n?s:l}__title`],
                                children: [document.createTextNode(r === n ? a.replace("%s", e) : o("Save %s", "elementor-pro").replace("%s", e))]
                            })]
                        }),
                        m = [s];
                    r !== n && m.push(l);
                    ...
                    return c.addEventListener("click", t), c
                }({
                    title: n,
                    onClick: () => async function onDocumentClick(e, t, n = null, o = null) {
                ...
                e.prepend(c), r === a && (e.dataset.editableElementorDocument = t)
            };
            const s = "elementor-document-handle",
                i = "elementor-edit-mode",
                r = t.EDIT_CONTEXT = "edit",
                l = "elementor-document-save-back-handle",
            ...
            function createElement({
                ...
                return o.classList.add(...t), n.forEach((e => o.appendChild(e))), o
            }
        },
        2813: (e, t, n) => {
            var o = n(2470).__,
            ...
            class Loop extends i.default {
                ...
                attachEditDocumentHandle() {
                    ...
                    i && (this.isFirstEdit() ? this.$element.find(".elementor-swiper-button").remove() : (0, r.default)({
                        element: i,
                ...
                onInit(...e) {
                    super.onInit(...e), elementorFrontend.isEditMode() && (this.doEditorInitAction(), this.attachEditDocumentHandle(), this.handleCTA())
                }
            }
            t.default = Loop
        },
